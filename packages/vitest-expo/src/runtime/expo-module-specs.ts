 ...
 * Vendored from jest-expo@57.0.4 (Expo, MIT):
...
export const JEST_EXPO_VERSION = '57.0.4';
...
export const EXPO_MODULE_SPECS: Record<string, ModuleSpec> = {
    ...
    "exportedMethods": {
      ...
      "mock": {
        ...
        "ExpoAppMetrics": [
          ...
          {
            "name": "simulateCrashReport",
            "argumentsCount": 0,
            "key": "simulateCrashReport"
          },
          {
            "name": "triggerCrash",
            "argumentsCount": 1,
        ...
        "ExpoGo": [
          {
            "name": "getModulesSchema",
            "argumentsCount": 0,
            "key": "getModulesSchema"
          }
        ],
        "ExpoHaptics": [
          {
        ...
        "ExpoRouter": [
          {
            "name": "Material3DynamicColor",
            "argumentsCount": 2,
            "key": "Material3DynamicColor"
          },
          {
            "name": "Material3Color",
            "argumentsCount": 2,
    ...
    "modulesConstants": {
      ...
      "mockDefinition": {
        ...
        "ExpoAppMetrics": {
          ...
          "getAppStartupTimesAsync": {
            "type": "function"
          },
          "getFrameRateMetricsAsync": {
            "type": "function"
          },
          "getMemoryUsageSnapshotAsync": {
            "type": "function"
          },
          "logEvent": {
            "type": "function"
  ...
  "ExponentTest": {
    ...
    "shouldSkipTestsRequiringPermissionsAsync": {
      "type": "function",
      "functionType": "promise"
    }
  },
